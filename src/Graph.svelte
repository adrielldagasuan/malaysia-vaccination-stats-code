<script>
  ...
  function getPoints() {
    ...
    for (var i = 1; i <= numberOfXMarkers; i++) {
      ...
      points.push([Math.round(i * gapAsXDistance), translateYAxis(count), date, count])
    }
...
<main>
  <svg bind:this={graph}
    ...
    <!-- x axis -->
		...
		<line x1="0" x2={width+5} y1={height} y2={height}></line>
    {#if showDetail}
      <line x1={xPos} x2={xPos} y1="0" y2={height}></line>
